    ...
    (function (grid) {
        ...
        var RowRenderer = (function () {
            ...
            RowRenderer.prototype.ensureRowsRendered = function () {
                ...
                var rowsToRemove = Object.keys(this.renderedRows);
                // add in new rows
                //console.log("VAR",this.firstVirtualRenderedRow,this.lastVirtualRenderedRow)
                for (var rowIndex = this.firstVirtualRenderedRow; rowIndex <= this.lastVirtualRenderedRow; rowIndex++) {
                	//console.log("MUESTRA",rowsToRemove)
                    // see if item already there, and if yes, take it out of the 'to remove' array
                    if (rowsToRemove.indexOf(rowIndex.toString()) >= 0) {
                        rowsToRemove.splice(rowsToRemove.indexOf(rowIndex.toString()), 1);
                       // console.log("ROWTOREM")
                        continue;
                    }
                    // check this row actually exists (in case overflow buffer window exceeds real data)
                	//console.log("NODEANTES",node)
    ...
    (function (grid) {
        ...
        var VirtualPageRowController = (function () {
            ...
            VirtualPageRowController.prototype.getVirtualRow = function (rowIndex) {
               ...
               // console.log("PAGE ES",page,pageNumber,this.pageCache,rowIndex)
    ...
    (function (grid) {
        var Grid = (function () {
            function Grid(eGridDiv, gridOptions, globalEventListener, $scope, $compile, quickFilterOnScope) {
                ...
                if (gridOptions.ready!=undefined){
                	gridOptions.ready()
                }
